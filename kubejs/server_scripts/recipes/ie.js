...
events.listen("recipes", (event) => {
  ...
  event.recipes.immersiveengineering.crusher(
    item.of("appliedenergistics2:nether_quartz_dust"),
    "#forge:gems/quartz"
  );
  ...
  event.shapeless(Item.of("thermal:enderium_plate"), [
    "immersiveengineering:hammer",
    "#forge:ingots/enderium",
  ]);
  event.shapeless(Item.of("thermal:tin_plate"), [
    "immersiveengineering:hammer",
    "#forge:ingots/tin",
  ]);
  event.shapeless(Item.of("thermal:bronze_plate"), [
    "immersiveengineering:hammer",
    "#forge:ingots/bronze",
  ]);
  event.shapeless(Item.of("thermal:invar_plate"), [
    "immersiveengineering:hammer",
    "#forge:ingots/invar",
  ]);
  event.shapeless(Item.of("thermal:signalum_plate"), [
    "immersiveengineering:hammer",
    "#forge:ingots/signalum",
  ]);
  event.shapeless(Item.of("thermal:lumium_plate"), [
    "immersiveengineering:hammer",
    "#forge:ingots/lumium",
  ]);
});
